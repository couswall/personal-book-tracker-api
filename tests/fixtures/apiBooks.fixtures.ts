    ...
    items: [
        {
            ...
            searchInfo: {
                textSnippet:
                    'Improve your TypeScript code with practical tips and techniques.',
            },
        },
        {
            kind: Kind.BooksVolume,
        ...
        },
        {
            ...
            accessInfo: {
                ...
                epub: {
                    isAvailable: true,
                    acsTokenLink: 'https://token.example.com/book3',
                },
            ...
            searchInfo: {
                textSnippet:
                    'Master TypeScript and build scalable, maintainable applications.',
            },
        },
    ],
};
