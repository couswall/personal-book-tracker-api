...
export const bookObj = {
    ...
    description:
        'A comprehensive guide to TypeScript for beginners and advanced developers.',
    pageCount: 450,
...
export const createBookDtoObj = {
    ...
    description:
        'A deep dive into JavaScript, covering both fundamentals and advanced topics for serious developers.',
