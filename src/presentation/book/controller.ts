...
import {isPrintType} from '@presentation/validators/is-print-type';
import {BookRepository} from '@domain/repositories/book.repository';
import {SearchBook, GetBookById} from '@domain/use-cases/index';
import {CustomError} from '@domain/errors/custom.error';

export class BookController {
    constructor(private readonly reposiotry: BookRepository) {}
    ...
    public searchBook = (req: Request, res: Response) => {
        ...
        const queryDto = {
            ...
            printType: isPrintType(printType) ? printType : undefined,
